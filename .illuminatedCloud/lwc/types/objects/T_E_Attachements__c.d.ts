...
/**
 * <h3><b>KOL/Speaker Attachment</b></h3>
 * <p>This is to replace the standard Notes and Attachments against Contacts, will be used only for the HQ T&amp;E to store sensitive attachments for &quot;Speaker/KOL Contracts&quot; to hide this information from the Contact Owner.  This new object will help us to control the security.</p>
 */
declare interface T_E_Attachements__c extends SObject 
{
    /**
    ...
    Shares: T_E_Attachements__Share[];
