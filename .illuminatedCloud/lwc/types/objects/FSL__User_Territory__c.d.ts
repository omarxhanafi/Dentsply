...
/**
 * <h3><b>User Territory</b></h3>
 * <p>Which Territories are visible to this user (Default = All)</p>
 */
declare interface FSL__User_Territory__c extends SObject 
{
    /**
     ...
     * <tr><td nowrap><b>Formula:</b></td><td><code style="background-color: rgba(174, 184, 193, 0.2); border-width: 0; padding: 1px 4px; margin: 1px 0;">FSL__ServiceTerritory__r.Name</code></td></tr>
