 ...
 * <p>Internal object (Used within CRM team)  to track meeting mi nutes for project meetings and Success Team Meetings etc.</p>
 */
declare interface PM_Meeting_Minutes__c extends SObject 
{
    /**
     ...
     * <tr><td nowrap><b>Default Value:</b></td><td><code style="background-color: rgba(174, 184, 193, 0.2); border-width: 0; padding: 1px 4px; margin: 1px 0;">$User.FirstName &amp; &#39; &#39; &amp;  $User.LastName</code></td></tr>
     * </table>
     */
    Attendees__c: string;
    ...
    /**
     * The reciprocal relationship for {@link CRM_Request__c.Meeting_Minutes__c}.
     */
     ...
     * </table>
     */
    Meeting_end__c: string;
    /**
     * <h3><b>Meeting start</b></h3>
     * <h4>Field Attributes</h4>
     * <table border="0" valign="top">
     * <tr><td nowrap><b>Data Type:</b></td><td nowrap>Date Time</td></tr>
     * <tr><td nowrap><b>Required:</b></td><td nowrap>false</td></tr>
     * </table>
     */
    Meeting_start__c: string;
    /**
     * <h3><b>Meeting status</b></h3>
     * <h4>Field Attributes</h4>
     * <table border="0" valign="top">
    ...
    Shares: PM_Meeting_Minutes__Share[];
    SobjectLookupValue: AIInsightValue;
    SystemModstamp: string;
    Tags: PM_Meeting_Minutes__Tag[];
