...
/**
 * <h3><b>Maps Advanced Route Continuous Travel</b></h3>
 * <p>This holds the possible start and stop locations for users</p>
 */
declare interface maps__AdvRouteContinuousTravel__c extends SObject 
{
    ...
    Shares: AdvRouteContinuousTravel__Share[];
    SobjectLookupValue: AIInsightValue;
    SystemModstamp: string;
    Tags: AdvRouteContinuousTravel__Tag[];
