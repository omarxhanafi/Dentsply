...
/**
 * <h3><b>Log Connector</b></h3>
 * <p>Junction object for Log.</p>
 */
declare interface CventEvents__LogConnector__c extends SObject 
{
    ...
    Histories: LogConnector__History[];
    IsDeleted: boolean;
