...
/**
 * <h3><b>Maps Live Working Hours</b></h3>
 */
declare interface maps__LiveWorkingHours__c extends SObject 
{
    /**
    ...
    maps__LiveDrivers__r: LiveDriver__c[];
    /**
    ...
    Shares: LiveWorkingHours__Share[];
    SobjectLookupValue: AIInsightValue;
    SystemModstamp: string;
    Tags: LiveWorkingHours__Tag[];
