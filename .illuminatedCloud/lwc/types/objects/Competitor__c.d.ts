 ...
 * <p>This object is used to link Competitors (Which are ACCOUNTS!) with the correct accounts, to determine which competitors are connected to which customers and prospects.
 * Designed as a simple M:M relationship object</p>
 */
declare interface Competitor__c extends SObject 
{
    /**
     * <h3><b>Account</b></h3>
