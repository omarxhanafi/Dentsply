...
/**
 * <h3><b>TeamForce Release</b></h3>
 * <p>Used to track releases and dates along with them.</p>
 */
declare interface TeamForce_Release__c extends SObject 
{
    /**
     ...
     */
    ReleaseDate__c: Date;
    Shares: TeamForce_Release__Share[];
    ...
    Tags: TeamForce_Release__Tag[];
    Target: AIRecordInsight;
    TargetObject: PendingServiceRoutingInteractionInfo;
    TaskRelations: TaskRelation[];
    /**
     * The reciprocal relationship for {@link TeamForce_Sandbox__c.Release__c}.
     */
    TeamForce_Sandboxes__r: TeamForce_Sandbox__c[];
