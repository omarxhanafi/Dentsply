 ...
 * <p>This object will hold the settings used for Advanced Routes</p>
 */
declare interface maps__AdvRouteSettings__c extends SObject 
{
    ...
    maps__AdvRouteContinuousTravels__r: AdvRouteContinuousTravel__c[];
    /**
    ...
    Shares: AdvRouteSettings__Share[];
    SobjectLookupValue: AIInsightValue;
    SystemModstamp: string;
    Tags: AdvRouteSettings__Tag[];
