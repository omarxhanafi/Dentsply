...
/**
 * <h3><b>Customer Agreement</b></h3>
 * <p>Initial purpose: The LAB sales reps need to have customer agreements (Direct Discounts, Bonus Agreements, Individual Agreements)  available in Salesforce for their customers (stored in SAP ERP Hanau. Local analysts can upload the discounts by themselves waiting for a future integration to be built.</p>
 */
declare interface CustomerAgreement__c extends SObject 
{
    /**
     * <h3><b>Account</b></h3>
    ...
    Histories: CustomerAgreement__History[];
    IsDeleted: boolean;
