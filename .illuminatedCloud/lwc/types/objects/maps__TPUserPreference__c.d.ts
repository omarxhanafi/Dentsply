...
/**
 * <h3><b>Territory Planning User Preference</b></h3>
 */
declare interface maps__TPUserPreference__c extends SObject 
{
    /**
    ...
    Shares: TPUserPreference__Share[];
    SobjectLookupValue: AIInsightValue;
    SystemModstamp: string;
    Tags: TPUserPreference__Tag[];
