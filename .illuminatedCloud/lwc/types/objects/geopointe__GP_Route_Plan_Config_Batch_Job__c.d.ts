...
/**
 * <h3><b>Geopointe Route Plan Config Batch Job</b></h3>
 * <p>Stores data for the batch job from one route plan configuration.</p>
 */
declare interface geopointe__GP_Route_Plan_Config_Batch_Job__c extends SObject 
{
     ...
     * <h4>Field Attributes</h4>
     * <table border="0" valign="top">
     * <tr><td nowrap><b>Data Type:</b></td><td nowrap>Master Detail({@link geopointe__GP_Route_Plan_Configuration__c})</td></tr>
     * <tr><td nowrap><b>External ID:</b></td><td nowrap>false</td></tr>
     * </table>
     */
