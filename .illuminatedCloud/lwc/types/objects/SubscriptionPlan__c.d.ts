 ...
 * <p>Implemented to visualize subscriptions a customer has.
 * Implemenetd to support the DS Core, DS Care and DS Create subscription based products.
 * Data around subscriptions for DS Core, Care and Create is received from Zuora via DEP.</p>
 */
declare interface SubscriptionPlan__c extends SObject 
{
    /**
     * <h3><b>Account</b></h3>
