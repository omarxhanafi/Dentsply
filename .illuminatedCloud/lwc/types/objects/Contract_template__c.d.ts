...
/**
 * <h3><b>Contract template</b></h3>
 * <p>Used for mapping contracts in SFDC to contract templates in Movex on behalf of Customer Service</p>
 */
declare interface Contract_template__c extends SObject 
{
    /**
    ...
    Shares: Contract_template__Share[];
    SobjectLookupValue: AIInsightValue;
    SystemModstamp: string;
    Tags: Contract_template__Tag[];
