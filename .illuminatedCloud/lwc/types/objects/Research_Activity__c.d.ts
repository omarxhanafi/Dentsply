 ...
 * <p>This object contains information of Research Activities. Typical research activities are IIS and CIS studies, which this object is created based on</p>
 */
declare interface Research_Activity__c extends SObject 
{
     ...
     * <tr><td nowrap><b>Data Type:</b></td><td nowrap>Lookup({@link Expert__c})</td></tr>
     ...
     * <tr><td nowrap><code style="background-color: rgba(174, 184, 193, 0.2); border-width: 0; padding: 1px 4px; margin: 1px 0;">Approved</code></td><td>Approved</td><td nowrap>true</td><td nowrap>true</td></tr>
