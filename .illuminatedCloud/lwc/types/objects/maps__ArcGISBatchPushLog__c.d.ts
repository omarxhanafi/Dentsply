...
/**
 * <h3><b>Maps ArcGIS Batch Push Log</b></h3>
 */
declare interface maps__ArcGISBatchPushLog__c extends SObject 
{
    /**
    ...
    Shares: ArcGISBatchPushLog__Share[];
    SobjectLookupValue: AIInsightValue;
    SystemModstamp: string;
    Tags: ArcGISBatchPushLog__Tag[];
