...
/**
 * <h3><b>TeamForce Release Documentation</b></h3>
 * <p>Used to document changes that come in with a release. Records are owned by related US owners. Only relevant to changes that are relevant to all countries.</p>
 */
declare interface Teamforce_Release_Documentation__c extends SObject 
{
    /**
     * <h3><b>Access automatically provided</b></h3>
