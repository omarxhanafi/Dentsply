 ...
 */
declare interface echosign_dev1__SIGN_Data_Mapping__c extends SObject 
{
    /**
    ...
    echosign_dev1__Object_Mappings__r: SIGN_Object_Mapping__c[];
    ...
    Shares: SIGN_Data_Mapping__Share[];
    SobjectLookupValue: AIInsightValue;
    SystemModstamp: string;
    Tags: SIGN_Data_Mapping__Tag[];
