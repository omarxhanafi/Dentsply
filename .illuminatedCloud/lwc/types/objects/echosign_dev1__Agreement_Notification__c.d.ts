...
/**
 * <h3><b>Agreement Notification</b></h3>
 */
declare interface echosign_dev1__Agreement_Notification__c extends SObject 
{
    /**
     ...
     * <tr><td nowrap><code style="background-color: rgba(174, 184, 193, 0.2); border-width: 0; padding: 1px 4px; margin: 1px 0;">AUTO_UPDATE</code></td><td>AUTO_UPDATE</td><td nowrap>true</td><td nowrap>true</td></tr>
    ...
    Tags: Agreement_Notification__Tag[];
