 ...
 * <p>Volume discount schedule that applies automatic discounts based on quantity.</p>
 */
declare interface SBQQ__DiscountSchedule__c extends SObject 
{
    /**
     * The reciprocal relationship for {@link SBQQ__ContractedPrice__c.SBQQ__DiscountSchedule__c}.
     */
    ...
    CreatedDate: string;
    /**
     * The reciprocal relationship for {@link SBQQ__Dimension__c.SBQQ__DiscountSchedule__c}.
     */
    Dimensions__r: SBQQ__Dimension__c[];
    /**
     * The reciprocal relationship for {@link SBQQ__DiscountSchedule__c.SBQQ__OriginalDiscountSchedule__c}.
     */
    DiscountSchedules__r: SBQQ__DiscountSchedule__c[];
    /**
     * The reciprocal relationship for {@link SBQQ__DiscountTier__c.SBQQ__Schedule__c}.
     */
    DiscountTiers__r: SBQQ__DiscountTier__c[];
    /**
     * The reciprocal relationship for {@link SBQQ__FavoriteProduct__c.SBQQ__DiscountSchedule__c}.
     */
    Favorite_Product__r: SBQQ__FavoriteProduct__c[];
    IsDeleted: boolean;
    LastModifiedBy: User;
    ...
    Name: string;
    /**
     * The reciprocal relationship for {@link SBQQ__PriceSchedule__c.SBQQ__OriginalDiscountSchedule__c}.
     */
    PriceSchedules__r: SBQQ__PriceSchedule__c[];
    /**
     * The reciprocal relationship for {@link SBQQ__ProductFeature__c.SBQQ__DiscountSchedule__c}.
     */
    ProductFeatures__r: SBQQ__ProductFeature__c[];
    /**
     * The reciprocal relationship for {@link SBQQ__ProductOption__c.SBQQ__DiscountSchedule__c}.
     */
    ProductOptions__r: SBQQ__ProductOption__c[];
    /**
     * The reciprocal relationship for {@link SBQQ__QuoteLine__c.SBQQ__DiscountSchedule__c}.
     */
    R00N70000001opkuEAA__r: SBQQ__QuoteLine__c[];
    /**
     * <h3><b>Account</b></h3>
     * <p>Account that this discount schedule applies to. Only used in combination with Discount Schedule Override on Quote Line Editor UI.</p>
     ...
     * <p>Description for this Discount Schedule.</p>
     * <h4>Field Attributes</h4>
     * <table border="0" valign="top">
     ...
     * <p>This is the Discount Unit for the Discount Schedule.</p>
     * <h4>Field Attributes</h4>
     * <table border="0" valign="top">
     * <tr><td nowrap><b>Data Type:</b></td><td nowrap>Picklist</td></tr>
     * <tr><td nowrap><b>Required:</b></td><td nowrap>false</td></tr>
     ...
     * <p>Comma-seperated list of price book IDs for which this discount schedule should not apply.</p>
     * <h4>Field Attributes</h4>
     * <table border="0" valign="top">
    ...
    /**
     * <h3><b>Order</b></h3>
     * <p>Order that this discount schedule applies to.</p>
     * <h4>Field Attributes</h4>
     * <table border="0" valign="top">
     ...
     * <p>Order product that this discount schedule applies to.</p>
     * <h4>Field Attributes</h4>
     * <table border="0" valign="top">
     ...
     * <p>The original Discount Schedule that was overridden to create this Discount Schedule.</p>
     * <h4>Field Attributes</h4>
     * <table border="0" valign="top">
     ...
     * <p>Price book that this discount schedule applies to. Only used in combination with Product lookup to assign product/price book specific schedule.</p>
     * <h4>Field Attributes</h4>
     * <table border="0" valign="top">
     ...
     * <p>Decimal places for prices produced by this discount schedule.</p>
     * <h4>Field Attributes</h4>
     * <table border="0" valign="top">
    ...
    /**
     * <h3><b>Product</b></h3>
     * <p>Product that this discount schedule applies to. Only used in combination with Price Book lookup to assign product/price book specific schedule.</p>
     * <h4>Field Attributes</h4>
     * <table border="0" valign="top">
    ...
    /**
     * <h3><b>Quote</b></h3>
     * <p>Quote that this discount schedule applies to. Only used in combination with Discount Schedule Override on Quote Line Editor UI.</p>
     * <h4>Field Attributes</h4>
     * <table border="0" valign="top">
     ...
     * <p>Quote Line that this discount schedule applies to. Only used in combination with Discount Schedule Override on Quote Line Editor UI.</p>
     * <h4>Field Attributes</h4>
     * <table border="0" valign="top">
     ...
     * <p>Field used to calculate discount schedule pricing.</p>
     * <h4>Field Attributes</h4>
     * <table border="0" valign="top">
     * <tr><td nowrap><b>Data Type:</b></td><td nowrap>Picklist</td></tr>
     * <tr><td nowrap><b>Required:</b></td><td nowrap>false</td></tr>
    ...
    /**
     * <h3><b>Type</b></h3>
     * <p>The type of discount schedule determines how the discount is calculated.</p>
     * <h4>Field Attributes</h4>
     * <table border="0" valign="top">
     * <tr><td nowrap><b>Data Type:</b></td><td nowrap>Picklist</td></tr>
     * <tr><td nowrap><b>Required:</b></td><td nowrap>false</td></tr>
     ...
     * <tr><td nowrap><code style="background-color: rgba(174, 184, 193, 0.2); border-width: 0; padding: 1px 4px; margin: 1px 0;">Slab</code></td><td>Slab</td><td nowrap>&nbsp;</td><td nowrap>true</td></tr>
     * </table>
     */
    SBQQ__Type__c: string;
    /**
     * <h3><b>Use Price For Amount</b></h3>
     * <p>If checked, the user defined Discount Schedule&#39;s Discount Unit will be set to Price.</p>
     * <h4>Field Attributes</h4>
     * <table border="0" valign="top">
     * <tr><td nowrap><b>Data Type:</b></td><td nowrap>Checkbox</td></tr>
     * <tr><td nowrap><b>External ID:</b></td><td nowrap>false</td></tr>
    ...
    /**
     * The reciprocal relationship for {@link SBQQ__Subscription__c.SBQQ__DiscountSchedule__c}.
     */
    Subscriptions__r: SBQQ__Subscription__c[];
    /**
     * The reciprocal relationship for {@link SBQQ__Dimension__c.SBQQ__TermDiscountSchedule__c}.
     */
    TermDiscountedDimensions__r: SBQQ__Dimension__c[];
    /**
     * The reciprocal relationship for {@link SBQQ__QuoteLine__c.SBQQ__TermDiscountSchedule__c}.
     */
    TermDiscountedQuoteLines__r: SBQQ__QuoteLine__c[];
    /**
     * The reciprocal relationship for {@link SBQQ__Subscription__c.SBQQ__TermDiscountSchedule__c}.
     */
    TermDiscountedSubscriptions__r: SBQQ__Subscription__c[];
    /**
     * The reciprocal relationship for {@link SBQQ__WebQuoteLine__c.SBQQ__TermDiscountSchedule__c}.
     */
    TermDiscountedWebQuoteLines__r: SBQQ__WebQuoteLine__c[];
    /**
     * The reciprocal relationship for {@link SBQQ__WebQuoteLine__c.SBQQ__DiscountSchedule__c}.
     */
