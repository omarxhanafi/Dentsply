...
/**
 * <h3><b>Maps Advanced Promotional Period Config</b></h3>
 */
declare interface maps__AdvRoutePromotionalPeriodConfiguration__c extends SObject 
{
    ...
    Shares: AdvRoutePromotionalPeriodConfiguration__Share[];
    SobjectLookupValue: AIInsightValue;
    SystemModstamp: string;
    Tags: AdvRoutePromotionalPeriodConfiguration__Tag[];
