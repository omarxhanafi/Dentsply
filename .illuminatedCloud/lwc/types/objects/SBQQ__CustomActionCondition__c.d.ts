...
/**
 * <h3><b>Custom Action Condition</b></h3>
 * <p>Condition that determines if the Action should be rendered on the page.</p>
 */
declare interface SBQQ__CustomActionCondition__c extends SObject 
{
     ...
     * <tr><td nowrap><b>Data Type:</b></td><td nowrap>Master Detail({@link SBQQ__CustomAction__c})</td></tr>
     ...
     * <tr><td nowrap><b>Formula:</b></td><td><code style="background-color: rgba(174, 184, 193, 0.2); border-width: 0; padding: 1px 4px; margin: 1px 0;">SBQQ__CustomAction__r.SBQQ__Active__c</code></td></tr>
     * <tr><td nowrap><b>External ID:</b></td><td nowrap>false</td></tr>
     * </table>
     */
