...
/**
 * <h3><b>Equipment Booking Config</b></h3>
 * <p>Used to control the behavior of equipment booking flows. Originally built for VDW business TFUS-000003992, but can be used for other use cases</p>
 */
declare interface EquipmentBookingConfig__mdt extends SObject 
{
    /**
     * <h3><b>Account Country</b></h3>
     * <p>Will be used to filter each configuration based on country</p>
