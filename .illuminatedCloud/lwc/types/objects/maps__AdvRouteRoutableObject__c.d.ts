 ...
 * <p>This will hold any Advanced Route defaults needed for an object</p>
 */
declare interface maps__AdvRouteRoutableObject__c extends SObject 
{
    ...
    Shares: AdvRouteRoutableObject__Share[];
    SobjectLookupValue: AIInsightValue;
    SystemModstamp: string;
    Tags: AdvRouteRoutableObject__Tag[];
