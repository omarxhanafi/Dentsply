 ...
 * <p>Used to track programs that an Account is participating at. Example could be a loyalty Program.
 * Note that the API label says LoyaltyProgram since that was the first design of it and intention for it - but has been relabeled to have a broader meaning and sense since whereas types of programs has arised as a need.</p>
 */
declare interface LoyaltyProgram__c extends SObject 
{
    /**
     ...
     * This field is used to show guidance on the account program member page.</p>
     * <h4>Field Attributes</h4>
     * <table border="0" valign="top">
