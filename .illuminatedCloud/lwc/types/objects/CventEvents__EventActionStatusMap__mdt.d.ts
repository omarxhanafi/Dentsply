...
/**
 * <h3><b>Event Action Status Map</b></h3>
 * <p>This represents a map of Event statuses to the Actions (Registration, Nomination, Invitation) that are available.</p>
 */
declare interface CventEvents__EventActionStatusMap__mdt extends SObject 
{
    /**
     * <h3><b>Allow Invitation</b></h3>
     * <p>Indicates whether the invitation to an event in this status is allowed.</p>
