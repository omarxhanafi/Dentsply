 ...
 * <p>These are the different Advanced Route waypoints/stops for a route</p>
 */
declare interface maps__AdvRouteWaypoint__c extends SObject 
{
    ...
    maps__Activities__r: LookedUpFromActivity[];
    /**
     * <h3><b>Address</b></h3>
    ...
    Shares: AdvRouteWaypoint__Share[];
    SobjectLookupValue: AIInsightValue;
    SystemModstamp: string;
    Tags: AdvRouteWaypoint__Tag[];
