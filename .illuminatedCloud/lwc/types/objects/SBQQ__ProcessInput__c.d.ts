 ...
 * <p>Input into a quote process. Information collected by inputs can be used to drive product selection and configuration.</p>
 */
declare interface SBQQ__ProcessInput__c extends SObject 
{
    CreatedBy: User;
    CreatedById: string;
    CreatedDate: string;
    /**
     * The reciprocal relationship for {@link SBQQ__ProcessInputCondition__c.SBQQ__MasterProcessInput__c}.
     */
    DependentInputs__r: SBQQ__ProcessInputCondition__c[];
    IsDeleted: boolean;
    LastModifiedBy: User;
    ...
    Name: string;
    /**
     * The reciprocal relationship for {@link SBQQ__ProcessInputValue__c.SBQQ__ProcessInputID__c}.
     */
    Process_Input_Values__r: SBQQ__ProcessInputValue__c[];
    /**
     * The reciprocal relationship for {@link SBQQ__ProcessInputCondition__c.SBQQ__ProcessInput__c}.
     */
    ProcessInputCondition__r: SBQQ__ProcessInputCondition__c[];
    /**
     * <h3><b>Active</b></h3>
     * <p>Indicates if this process input is active.</p>
     ...
     * </table>
     */
    SBQQ__BinaryChoice__c: string;
    /**
     * <h3><b>Conditions Met</b></h3>
     * <p>Indicates which Process Input conditions must be met.</p>
     * <h4>Field Attributes</h4>
     * <table border="0" valign="top">
     * <tr><td nowrap><b>Data Type:</b></td><td nowrap>Picklist</td></tr>
     * <tr><td nowrap><b>Required:</b></td><td nowrap>false</td></tr>
     ...
     * <p>Quote field that sources default value for this input.</p>
     * <h4>Field Attributes</h4>
     * <table border="0" valign="top">
     * <tr><td nowrap><b>Data Type:</b></td><td nowrap>Picklist</td></tr>
     * <tr><td nowrap><b>Required:</b></td><td nowrap>false</td></tr>
     ...
     * <table border="0" valign="top">
     * <tr><td nowrap><b>API Name</b></td><td nowrap><b>Label</b></td><td nowrap><b>Active</b></td></tr>
     * <tr><td nowrap><code style="background-color: rgba(174, 184, 193, 0.2); border-width: 0; padding: 1px 4px; margin: 1px 0;">Bill To Country</code></td><td>Bill To Country</td><td nowrap>true</td></tr>
     * <tr><td nowrap><code style="background-color: rgba(174, 184, 193, 0.2); border-width: 0; padding: 1px 4px; margin: 1px 0;">Ship To Country</code></td><td>Ship To Country</td><td nowrap>true</td></tr>
     * </table>
     */
    SBQQ__DefaultField__c: string;
    /**
     * <h3><b>Display Order</b></h3>
     * <p>The order that the process input is displayed.</p>
     * <h4>Field Attributes</h4>
     * <table border="0" valign="top">
    ...
    /**
     * <h3><b>Input Field</b></h3>
     * <p>The API name for the field that accepts the user entry.</p>
     * <h4>Field Attributes</h4>
     * <table border="0" valign="top">
     * <tr><td nowrap><b>Data Type:</b></td><td nowrap>Picklist</td></tr>
     * <tr><td nowrap><b>Required:</b></td><td nowrap>false</td></tr>
     ...
     * <table border="0" valign="top">
     * <tr><td nowrap><b>API Name</b></td><td nowrap><b>Label</b></td><td nowrap><b>Active</b></td></tr>
     * <tr><td nowrap><code style="background-color: rgba(174, 184, 193, 0.2); border-width: 0; padding: 1px 4px; margin: 1px 0;">BinaryChoice__c</code></td><td>BinaryChoice__c</td><td nowrap>true</td></tr>
     * <tr><td nowrap><code style="background-color: rgba(174, 184, 193, 0.2); border-width: 0; padding: 1px 4px; margin: 1px 0;">IntegerInput__c</code></td><td>IntegerInput__c</td><td nowrap>true</td></tr>
     * </table>
     */
    SBQQ__InputField__c: string;
    /**
     * <h3><b>Integer Input</b></h3>
     * <h4>Field Attributes</h4>
     * <table border="0" valign="top">
     ...
     * </table>
     */
    SBQQ__IntegerInput__c: number;
    /**
     * <h3><b>Label</b></h3>
     * <p>Label for this filter.</p>
     * <h4>Field Attributes</h4>
     * <table border="0" valign="top">
    ...
    /**
     * <h3><b>Operator</b></h3>
     * <p>The operator used when comparing the Input Field entry with the Product Field.</p>
     * <h4>Field Attributes</h4>
     * <table border="0" valign="top">
     * <tr><td nowrap><b>Data Type:</b></td><td nowrap>Picklist</td></tr>
     * <tr><td nowrap><b>Required:</b></td><td nowrap>false</td></tr>
     ...
     * <h4>Field Attributes</h4>
     * <table border="0" valign="top">
     * <tr><td nowrap><b>Data Type:</b></td><td nowrap>Lookup({@link SBQQ__ProcessInputCondition__c})</td></tr>
     * <tr><td nowrap><b>Required:</b></td><td nowrap>false</td></tr>
     * <tr><td nowrap><b>External ID:</b></td><td nowrap>false</td></tr>
     * </table>
     */
    SBQQ__ProcessInputCondition__c: string;
    /**
     * <h3><b>Process Input Condition</b></h3>
     * <h4>Field Attributes</h4>
     * <table border="0" valign="top">
     ...
     * </table>
     */
    SBQQ__ProcessInputCondition__r: SBQQ__ProcessInputCondition__c;
    /**
     * <h3><b>Product Field</b></h3>
     * <p>Field on Product object used in filtering products that match this input.</p>
     * <h4>Field Attributes</h4>
     * <table border="0" valign="top">
     * <tr><td nowrap><b>Data Type:</b></td><td nowrap>Picklist</td></tr>
     * <tr><td nowrap><b>Required:</b></td><td nowrap>false</td></tr>
     ...
     * <table border="0" valign="top">
     * <tr><td nowrap><b>API Name</b></td><td nowrap><b>Label</b></td><td nowrap><b>Active</b></td></tr>
     * <tr><td nowrap><code style="background-color: rgba(174, 184, 193, 0.2); border-width: 0; padding: 1px 4px; margin: 1px 0;">Product Name</code></td><td>Product Name</td><td nowrap>true</td></tr>
     ...
     * </table>
     */
    SBQQ__ProductField__c: string;
    /**
     * <h3><b>Quote Process</b></h3>
     * <p>Quote process that owns the input.</p>
     * <h4>Field Attributes</h4>
     * <table border="0" valign="top">
     * <tr><td nowrap><b>Data Type:</b></td><td nowrap>Master Detail({@link SBQQ__QuoteProcess__c})</td></tr>
     * <tr><td nowrap><b>External ID:</b></td><td nowrap>false</td></tr>
     * </table>
     */
