...
/**
 * <h3><b>Maps Live Summary Stop Config</b></h3>
 */
declare interface maps__LiveSummaryStopRelationshipConfig__c extends SObject 
{
    ...
    Histories: LiveSummaryStopRelationshipConfig__History[];
    IsDeleted: boolean;
    ...
    Tags: LiveSummaryStopRelationshipConfig__Tag[];
