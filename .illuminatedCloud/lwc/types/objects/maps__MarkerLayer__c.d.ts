 ...
 */
declare interface maps__MarkerLayer__c extends SObject 
{
    /**
     ...
     * <tr><td nowrap><code style="background-color: rgba(174, 184, 193, 0.2); border-width: 0; padding: 1px 4px; margin: 1px 0;">Static</code></td><td>Static</td><td nowrap>true</td></tr>
