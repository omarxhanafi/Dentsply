...
/**
 * <h3><b>Subscription Consumption Schedule</b></h3>
 */
declare interface SBQQ__SubscriptionConsumptionSchedule__c extends SObject 
{
    CreatedBy?: User;
    CreatedById?: string;
    CreatedDate?: string;
     ...
     * <tr><td nowrap><code style="background-color: rgba(174, 184, 193, 0.2); border-width: 0; padding: 1px 4px; margin: 1px 0;">Year</code></td><td>Year</td><td nowrap>true</td></tr>
     ...
     * <h4>Field Attributes</h4>
     * <table border="0" valign="top">
     * <tr><td nowrap><b>Data Type:</b></td><td nowrap>Lookup({@link ConsumptionSchedule})</td></tr>
     ...
     * <h4>Field Attributes</h4>
     * <table border="0" valign="top">
     * <tr><td nowrap><b>Data Type:</b></td><td nowrap>Master Detail({@link SBQQ__Subscription__c})</td></tr>
     * <tr><td nowrap><b>External ID:</b></td><td nowrap>false</td></tr>
     * </table>
     */
    ...
    /**
     * The reciprocal relationship for {@link SBQQ__SubscriptionConsumptionRate__c.SBQQ__SubscriptionConsumptionSchedule__c}.
     */
    SubscriptionConsumptionRates__r?: SBQQ__SubscriptionConsumptionRate__c[];
}