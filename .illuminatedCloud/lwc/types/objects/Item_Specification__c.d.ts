...
/**
 * <h3><b>Item Specification</b></h3>
 * <p>SBU: PREP &amp; ORTHO; Country: Japan - Used in Japan as a parallell product structure. This object is related to Item-object and a record of Item Specification is similar to a product in the product structure.
 * Potentially this object will be removed and instead relate the products from the global product structure to the Item-object instead.</p>
 */
declare interface Item_Specification__c extends SObject 
{
    /**
     ...
     * <tr><td nowrap><code style="background-color: rgba(174, 184, 193, 0.2); border-width: 0; padding: 1px 4px; margin: 1px 0;">Monopoly</code></td><td>Monopoly</td><td nowrap>true</td></tr>
     * <tr><td nowrap><code style="background-color: rgba(174, 184, 193, 0.2); border-width: 0; padding: 1px 4px; margin: 1px 0;">Special Order</code></td><td>Special Order</td><td nowrap>true</td></tr>
     * <tr><td nowrap><code style="background-color: rgba(174, 184, 193, 0.2); border-width: 0; padding: 1px 4px; margin: 1px 0;">Custom Order</code></td><td>Custom Order</td><td nowrap>true</td></tr>
     ...
     * <tr><td nowrap><b>Formula:</b></td><td><code style="background-color: rgba(174, 184, 193, 0.2); border-width: 0; padding: 1px 4px; margin: 1px 0;">if(  ISPICKVAL(  Stock_Status__c , &quot;Stock Only&quot;) , IMAGE(&quot;/servlet/servlet.FileDownload?file=01520000001F4GO&quot;, &quot;Stock Only&quot;) ,if(  ISPICKVAL( Stock_Status__c, &quot;End of Sales&quot;) , IMAGE(&quot;/servlet/servlet.FileDownload?file=01520000001F4G9&quot;, &quot;End of Sales&quot;) ,&quot;&quot;))</code></td></tr>
     * <tr><td nowrap><b>Required:</b></td><td nowrap>false</td></tr>
     * <tr><td nowrap><b>Unique:</b></td><td nowrap>false</td></tr>
     * <tr><td nowrap><b>External ID:</b></td><td nowrap>false</td></tr>
     * </table>
