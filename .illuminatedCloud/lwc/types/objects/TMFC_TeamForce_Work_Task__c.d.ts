...
/**
 * <h3><b>TeamForce Work Task</b></h3>
 */
declare interface TMFC_TeamForce_Work_Task__c extends SObject 
{
    /**
    ...
    Feeds: TMFC_TeamForce_Work_Task__Feed[];
    ...
    Histories: TMFC_TeamForce_Work_Task__History[];
    IsDeleted: boolean;
    LastModifiedBy: User;
    ...
    Tags: TMFC_TeamForce_Work_Task__Tag[];
