...
/**
 * <h3><b>Record Type Matching Settings</b></h3>
 * <p>Stores SF record types which are used during record matching process.</p>
 */
declare interface CventEvents__RecordTypeMatchingSettings__c extends SObject 
{
    /**
    ...
    Tags: RecordTypeMatchingSettings__Tag[];
