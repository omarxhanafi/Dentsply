 ...
 * <p>Content available in Showpad.</p>
 */
declare interface ShowpadForSF__Showpad_Content__c extends SObject 
{
    ...
    Histories?: Showpad_Content__History[];
    IsDeleted?: boolean;
    ...
    Shares?: Showpad_Content__Share[];
    ShowpadForSF__Contacts__r?: Contact[];
    /**
     ...
     * <tr><td nowrap><code style="background-color: rgba(174, 184, 193, 0.2); border-width: 0; padding: 1px 4px; margin: 1px 0;">audio</code></td><td>audio</td><td nowrap>true</td></tr>
     ...
     * <tr><td nowrap><code style="background-color: rgba(174, 184, 193, 0.2); border-width: 0; padding: 1px 4px; margin: 1px 0;">html content</code></td><td>html content</td><td nowrap>true</td></tr>
