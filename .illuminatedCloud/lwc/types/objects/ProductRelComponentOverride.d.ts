...
declare interface ProductRelComponentOverride extends SObject 
{
    ...
    Events: Event[];
    Feeds: ProductRelComponentOverrideFeed[];
    ...
    Histories: ProductRelComponentOverrideHistory[];
    ...
    Shares: ProductRelComponentOverrideShare[];
