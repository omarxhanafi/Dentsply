...
/**
 * <h3><b>Account Plan Objective</b></h3>
 * <p>This account plan is based on the &quot;OGSM&quot; strategic planning methodology: an OGSM is a written and easily communicated statement of an organization’s Objective, Goals, Strategies and Measures. OGSM brings alignment, transparency of priorities and metrics that define success.</p>
 */
declare interface Objective__c extends SObject 
{
    /**
     ...
     * <tr><td nowrap><code style="background-color: rgba(174, 184, 193, 0.2); border-width: 0; padding: 1px 4px; margin: 1px 0;">Green</code></td><td>Green</td><td nowrap>&nbsp;</td><td nowrap>true</td></tr>
     * <tr><td nowrap><code style="background-color: rgba(174, 184, 193, 0.2); border-width: 0; padding: 1px 4px; margin: 1px 0;">Yellow</code></td><td>Yellow</td><td nowrap>&nbsp;</td><td nowrap>true</td></tr>
