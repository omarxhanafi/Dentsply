 ...
 */
declare interface TMFC_TeamForce_Epic__c extends SObject 
{
    /**
    ...
    Feeds: TMFC_TeamForce_Epic__Feed[];
    ...
    Histories: TMFC_TeamForce_Epic__History[];
    IsDeleted: boolean;
    LastModifiedBy: User;
    ...
    Shares: TMFC_TeamForce_Epic__Share[];
    SobjectLookupValue: AIInsightValue;
    SystemModstamp: string;
    Tags: TMFC_TeamForce_Epic__Tag[];
    Target: AIRecordInsight;
    TargetObject: PendingServiceRoutingInteractionInfo;
    TaskRelations: TaskRelation[];
    /**
     * The reciprocal relationship for {@link TMFC_TeamForce_User_Story__c.TMFC_TeamForce_Epic__c}.
     */
