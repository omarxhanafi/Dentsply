...
/**
 * <h3><b>Event Campaign Settings</b></h3>
 * <p>Stores the app-wide configuration for event campaigns.</p>
 */
declare interface CventEvents__EventCampaignSettings__c extends SObject 
{
    /**
    ...
    Tags: EventCampaignSettings__Tag[];
