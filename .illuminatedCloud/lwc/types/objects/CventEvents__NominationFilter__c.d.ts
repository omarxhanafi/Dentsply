 ...
 * <p>Stores the filter criteria used for the nomination process.</p>
 */
declare interface CventEvents__NominationFilter__c extends SObject 
{
    /**
    ...
    CventEvents__NominationConditions__r: NominationCondition__c[];
    CventEvents__NominationRules__r: NominationRule__c[];
    /**
     * <h3><b>Title</b></h3>
    ...
    Shares: NominationFilter__Share[];
    SobjectLookupValue: AIInsightValue;
    SystemModstamp: string;
    Tags: NominationFilter__Tag[];
