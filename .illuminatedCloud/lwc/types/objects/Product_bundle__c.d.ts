 ...
 */
declare interface Product_bundle__c extends SObject 
{
    /**
     * <h3><b>Active?</b></h3>
    ...
    /**
     * The reciprocal relationship for {@link BOM__c.Product_bundle__c}.
     */
    ...
    /**
     * The reciprocal relationship for {@link Order_bundle__c.Product_bundle__c}.
     */
    Order_bundles__r?: Order_bundle__c[];
    Owner?: SObject;
    OwnerId?: string;
    Parent?: Case__hd;
    ...
    Quantity__c?: number;
    /**
     * The reciprocal relationship for {@link QuoteProductBundle__c.ProductBundle__c}.
     */
    ...
    /**
     * The reciprocal relationship for {@link Refined_pricebook_items__c.Product_bundle__c}.
     */
     ...
     * <tr><td nowrap><b>Summary Foreign Key:</b></td><td nowrap><code style="background-color: rgba(174, 184, 193, 0.2); border-width: 0; padding: 1px 4px; margin: 1px 0;">BOM__c.Product_bundle__c</code></td></tr>
