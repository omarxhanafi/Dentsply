...
/**
 * <h3><b>Encryption Settings</b></h3>
 * <p>This custom setting stores configuration data related to encryption settings. It includes essential information such as encryption keys and other parameters required for secure data handling</p>
 */
declare interface EncryptionSettings__c extends SObject 
{
    /**
     * <h3><b>AES Key</b></h3>
