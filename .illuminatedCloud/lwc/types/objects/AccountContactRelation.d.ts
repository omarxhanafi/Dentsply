...
declare interface AccountContactRelation extends SObject 
{
     ...
     * <tr><td nowrap><code style="background-color: rgba(174, 184, 193, 0.2); border-width: 0; padding: 1px 4px; margin: 1px 0;">Dealer Sales Rep (CEREC)</code></td><td>Dealer Sales Rep (CEREC)</td><td nowrap>true</td></tr>
     ...
     * <tr><td nowrap><code style="background-color: rgba(174, 184, 193, 0.2); border-width: 0; padding: 1px 4px; margin: 1px 0;">Partner Sales Rep Imaging</code></td><td>Partner Sales Rep Imaging</td><td nowrap>true</td></tr>
