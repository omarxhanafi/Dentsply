...
/**
 * <h3><b>Order Stage Guidance</b></h3>
 * <p>Used to configure stage guidance for the OrderPathCmp shown for Orders in Lightning.</p>
 */
declare interface OrderStageGuidance__mdt extends SObject 
{
     ...
     * <tr><td nowrap><code style="background-color: rgba(174, 184, 193, 0.2); border-width: 0; padding: 1px 4px; margin: 1px 0;">Activated</code></td><td>Activated</td><td nowrap>&nbsp;</td><td nowrap>true</td></tr>
