 ...
 * <p>Details: A start Up Practice is a privately-shared record related to an existing account.
 * Use Case: A dentist working for that account is investigating the possibilities to start up their own clinic (in confidence with DS Sales Reps)
 * TFUS-000003211</p>
 */
declare interface StartUpPractice__c extends SObject 
{
    /**
     ...
     * <tr><td nowrap><code style="background-color: rgba(174, 184, 193, 0.2); border-width: 0; padding: 1px 4px; margin: 1px 0;">Cancellation of Start-Up Plans</code></td><td>Cancellation of Start-Up Plans</td><td nowrap>true</td></tr>
     * <tr><td nowrap><code style="background-color: rgba(174, 184, 193, 0.2); border-width: 0; padding: 1px 4px; margin: 1px 0;">Lost to Competitor</code></td><td>Lost to Competitor</td><td nowrap>true</td></tr>
     ...
     * <tr><td nowrap><b>Formula:</b></td><td><code style="background-color: rgba(174, 184, 193, 0.2); border-width: 0; padding: 1px 4px; margin: 1px 0;">Probability__c *  OverallSalesBudget__c</code></td></tr>
     * <tr><td nowrap><b>Required:</b></td><td nowrap>false</td></tr>
     * </table>
     */
     ...
     * Finance Company (for those start-up clinics the doctors work together with big Finance companies),
     * Fit-out Company/Design Agency/... (for those start up clinics the doctors work together with big Fit-out/Design companies),
     * Referral (from other existing customers)</p>
     * <h4>Field Attributes</h4>
     * <table border="0" valign="top">
     * <tr><td nowrap><b>Data Type:</b></td><td nowrap>Picklist</td></tr>
     * <tr><td nowrap><b>Required:</b></td><td nowrap>false</td></tr>
     ...
     * <table border="0" valign="top">
     * <tr><td nowrap><b>API Name</b></td><td nowrap><b>Label</b></td><td nowrap><b>Active</b></td></tr>
     * <tr><td nowrap><code style="background-color: rgba(174, 184, 193, 0.2); border-width: 0; padding: 1px 4px; margin: 1px 0;">Design Agency</code></td><td>Design Agency</td><td nowrap>true</td></tr>
     ...
     * <tr><td nowrap><code style="background-color: rgba(174, 184, 193, 0.2); border-width: 0; padding: 1px 4px; margin: 1px 0;">DS Internal</code></td><td>DS Internal</td><td nowrap>true</td></tr>
     * <tr><td nowrap><code style="background-color: rgba(174, 184, 193, 0.2); border-width: 0; padding: 1px 4px; margin: 1px 0;">Finance Company</code></td><td>Finance Company</td><td nowrap>true</td></tr>
     * <tr><td nowrap><code style="background-color: rgba(174, 184, 193, 0.2); border-width: 0; padding: 1px 4px; margin: 1px 0;">Fit-out Company</code></td><td>Fit-out Company</td><td nowrap>true</td></tr>
     ...
     * <table border="0" valign="top">
     * <tr><td nowrap><b>API Name</b></td><td nowrap><b>Label</b></td><td nowrap><b>Default</b></td><td nowrap><b>Active</b></td></tr>
     * <tr><td nowrap><code style="background-color: rgba(174, 184, 193, 0.2); border-width: 0; padding: 1px 4px; margin: 1px 0;">Initial Discussions</code></td><td>Initial Discussions</td><td nowrap>true</td><td nowrap>true</td></tr>
     * <tr><td nowrap><code style="background-color: rgba(174, 184, 193, 0.2); border-width: 0; padding: 1px 4px; margin: 1px 0;">Identifying Needs</code></td><td>Identifying Needs</td><td nowrap>&nbsp;</td><td nowrap>true</td></tr>
     * <tr><td nowrap><code style="background-color: rgba(174, 184, 193, 0.2); border-width: 0; padding: 1px 4px; margin: 1px 0;">Pricing Discussions</code></td><td>Pricing Discussions</td><td nowrap>&nbsp;</td><td nowrap>true</td></tr>
     ...
     * <tr><td nowrap><code style="background-color: rgba(174, 184, 193, 0.2); border-width: 0; padding: 1px 4px; margin: 1px 0;">Practice Created</code></td><td>Practice Created</td><td nowrap>&nbsp;</td><td nowrap>true</td></tr>
