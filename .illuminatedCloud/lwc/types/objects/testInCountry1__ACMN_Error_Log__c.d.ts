 ...
 * <p>Used to store error logs outside of debug</p>
 */
declare interface testInCountry1__ACMN_Error_Log__c extends SObject 
{
    /**
    ...
    Shares: ACMN_Error_Log__Share[];
    SobjectLookupValue: AIInsightValue;
    SystemModstamp: string;
    Tags: ACMN_Error_Log__Tag[];
