...
/**
 * <h3><b>Cvent Connection</b></h3>
 * <p>Stores the Cvent connections history.</p>
 */
declare interface CventEvents__CventConnection__c extends SObject 
{
    /**
     ...
     * <tr><td nowrap><code style="background-color: rgba(174, 184, 193, 0.2); border-width: 0; padding: 1px 4px; margin: 1px 0;">Premium</code></td><td>Premium</td><td nowrap>true</td></tr>
    ...
    Shares?: CventConnection__Share[];
    SobjectLookupValue?: AIInsightValue;
    SystemModstamp?: string;
    Tags?: CventConnection__Tag[];
