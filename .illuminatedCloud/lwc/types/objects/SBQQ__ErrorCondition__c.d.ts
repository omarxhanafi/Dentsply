...
/**
 * <h3><b>Error Condition</b></h3>
 * <p>Error condition that causes parent Product Rule to fail.</p>
 */
declare interface SBQQ__ErrorCondition__c extends SObject 
{
     ...
     * <table border="0" valign="top">
     * <tr><td nowrap><b>Data Type:</b></td><td nowrap>Checkbox</td></tr>
     * <tr><td nowrap><b>Formula:</b></td><td><code style="background-color: rgba(174, 184, 193, 0.2); border-width: 0; padding: 1px 4px; margin: 1px 0;">ISPICKVAL(SBQQ__Rule__r.SBQQ__Scope__c, &#39;Quote&#39;)</code></td></tr>
     * <tr><td nowrap><b>External ID:</b></td><td nowrap>false</td></tr>
     * </table>
     */
     ...
     * <tr><td nowrap><code style="background-color: rgba(174, 184, 193, 0.2); border-width: 0; padding: 1px 4px; margin: 1px 0;">Quote Line Group</code></td><td>Quote Line Group</td><td nowrap>true</td></tr>
