...
/**
 * <h3><b>Maps MiniMap Setting</b></h3>
 */
declare interface maps__MiniMapSetting__c extends SObject 
{
    /**
     ...
     * <tr><td nowrap><code style="background-color: rgba(174, 184, 193, 0.2); border-width: 0; padding: 1px 4px; margin: 1px 0;">Console</code></td><td>Console</td><td nowrap>true</td></tr>
    ...
    Shares?: MiniMapSetting__Share[];
    SobjectLookupValue?: AIInsightValue;
    SystemModstamp?: string;
    Tags?: MiniMapSetting__Tag[];
