...
/**
 * <h3><b>Marketing Activity</b></h3>
 * <p>An object created to manage marketing activities recorded on customer and prospect Contacts in Eloqua.</p>
 */
declare interface Marketing_Activities__c extends SObject 
{
    /**
     * <h3><b>Activity type</b></h3>
     * <p>Shows what type of activity the customer or lead has completed</p>
     ...
     * <tr><td nowrap><code style="background-color: rgba(174, 184, 193, 0.2); border-width: 0; padding: 1px 4px; margin: 1px 0;">Visiting the website</code></td><td>Visiting the website</td><td nowrap>true</td></tr>
     * <tr><td nowrap><code style="background-color: rgba(174, 184, 193, 0.2); border-width: 0; padding: 1px 4px; margin: 1px 0;">Clicking an Eloqua email</code></td><td>Clicking an Eloqua email</td><td nowrap>true</td></tr>
