...
declare module "@salesforce/apex/UsersInAccountTerritories.getLeadOppSettingsByCountryAndBrand" {
    export default function getLeadOppSettingsByCountryAndBrand(params: {countryInput: string, brandInput: string}): Promise<any>;
}

declare module "@salesforce/apex/UsersInAccountTerritories.getOpportunitySettings" {
    export default function getOpportunitySettings(params: {category: string, accountid: string}): Promise<any[]>;
}
...
declare module "@salesforce/apex/UsersInAccountTerritories.getSuggestedUsers" {
    export default function getSuggestedUsers(params: {accountId: string, categoryInput: string, brandInput: string, dealerId: string}): Promise<any[]>;
}

declare module "@salesforce/apex/UsersInAccountTerritories.getUsers" {
    export default function getUsers(params: {recordId: string, categoryInput: string, brandInput: string, dealerId: string}): Promise<any[]>;
}
