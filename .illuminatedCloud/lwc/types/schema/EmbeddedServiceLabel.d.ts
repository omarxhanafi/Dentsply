...
declare module "@salesforce/schema/EmbeddedServiceLabel" {
    import { ObjectId } from "@salesforce/schema";
    const EmbeddedServiceLabel: ObjectId;
    export default EmbeddedServiceLabel;
}

declare module "@salesforce/schema/EmbeddedServiceLabel.CustomLabelName" {
    import { FieldId } from "@salesforce/schema";
    const CustomLabelName: FieldId;
...
declare module "@salesforce/schema/EmbeddedServiceLabel.EmbeddedServiceConfigDeveloperName" {
    import { FieldId } from "@salesforce/schema";
    const EmbeddedServiceConfigDeveloperName: FieldId;
...
declare module "@salesforce/schema/EmbeddedServiceLabel.UserRecordAccess" {
    import { FieldId } from "@salesforce/schema";
