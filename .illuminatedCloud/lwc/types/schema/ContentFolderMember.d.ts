...
declare module "@salesforce/schema/ContentFolderMember" {
    import { ObjectId } from "@salesforce/schema";
    const ContentFolderMember: ObjectId;
    export default ContentFolderMember;
}
...
declare module "@salesforce/schema/ContentFolderMember.ChildRecordId" {
    import { FieldId } from "@salesforce/schema";
    const ChildRecordId: FieldId;
    export default ChildRecordId;
}

declare module "@salesforce/schema/ContentFolderMember.ContextRecord" {
    import { FieldId } from "@salesforce/schema";
...
declare module "@salesforce/schema/ContentFolderMember.RelatedRecord" {
    import { FieldId } from "@salesforce/schema";
...
declare module "@salesforce/schema/ContentFolderMember.UserRecordAccess" {
    import { FieldId } from "@salesforce/schema";
