...
declare module "@salesforce/schema/UserPackageLicense" {
    import { ObjectId } from "@salesforce/schema";
    const UserPackageLicense: ObjectId;
    export default UserPackageLicense;
}
...
declare module "@salesforce/schema/UserPackageLicense.PackageLicenseId" {
    import { FieldId } from "@salesforce/schema";
    const PackageLicenseId: FieldId;
...
declare module "@salesforce/schema/UserPackageLicense.UserRecordAccess" {
    import { FieldId } from "@salesforce/schema";
