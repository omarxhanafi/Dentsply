...
declare module "@salesforce/schema/OpportunityContactRoleChangeEvent" {
    import { ObjectId } from "@salesforce/schema";
    const OpportunityContactRoleChangeEvent: ObjectId;
    export default OpportunityContactRoleChangeEvent;
}
...
declare module "@salesforce/schema/OpportunityContactRoleChangeEvent.CurrencyIsoCode" {
    import { FieldId } from "@salesforce/schema";
...
declare module "@salesforce/schema/OpportunityContactRoleChangeEvent.UserRecordAccess" {
    import { FieldId } from "@salesforce/schema";
