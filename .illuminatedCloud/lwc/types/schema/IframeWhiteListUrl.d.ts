...
declare module "@salesforce/schema/IframeWhiteListUrl" {
    import { ObjectId } from "@salesforce/schema";
    const IframeWhiteListUrl: ObjectId;
    export default IframeWhiteListUrl;
}

declare module "@salesforce/schema/IframeWhiteListUrl.Context" {
...
declare module "@salesforce/schema/IframeWhiteListUrl.UserRecordAccess" {
    import { FieldId } from "@salesforce/schema";
