...
declare module "@salesforce/schema/WorkTypeGroupHistory" {
    import { ObjectId } from "@salesforce/schema";
    const WorkTypeGroupHistory: ObjectId;
    export default WorkTypeGroupHistory;
}
...
declare module "@salesforce/schema/WorkTypeGroupHistory.DataType" {
    import { FieldId } from "@salesforce/schema";
...
declare module "@salesforce/schema/WorkTypeGroupHistory.UserRecordAccess" {
    import { FieldId } from "@salesforce/schema";
