...
declare module "@salesforce/schema/FeedPollVote" {
    import { ObjectId } from "@salesforce/schema";
    const FeedPollVote: ObjectId;
    export default FeedPollVote;
}

declare module "@salesforce/schema/FeedPollVote.Choice" {
    import { FieldId } from "@salesforce/schema";
    const Choice: FieldId;
    export default Choice;
}

declare module "@salesforce/schema/FeedPollVote.ChoiceId" {
    import { FieldId } from "@salesforce/schema";
    const ChoiceId: FieldId;
    export default ChoiceId;
}

declare module "@salesforce/schema/FeedPollVote.ContextRecord" {
    import { FieldId } from "@salesforce/schema";
...
declare module "@salesforce/schema/FeedPollVote.RelatedRecord" {
    import { FieldId } from "@salesforce/schema";
    const RelatedRecord: FieldId;
    export default RelatedRecord;
}

declare module "@salesforce/schema/FeedPollVote.UserRecordAccess" {
    import { FieldId } from "@salesforce/schema";
