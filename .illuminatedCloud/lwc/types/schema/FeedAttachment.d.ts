...
declare module "@salesforce/schema/FeedAttachment" {
    import { ObjectId } from "@salesforce/schema";
    const FeedAttachment: ObjectId;
    export default FeedAttachment;
}

declare module "@salesforce/schema/FeedAttachment.ContextRecord" {
...
declare module "@salesforce/schema/FeedAttachment.RelatedRecord" {
    import { FieldId } from "@salesforce/schema";
...
declare module "@salesforce/schema/FeedAttachment.UserRecordAccess" {
    import { FieldId } from "@salesforce/schema";
