...
declare module "@salesforce/schema/FlexQueueItem" {
    import { ObjectId } from "@salesforce/schema";
    const FlexQueueItem: ObjectId;
    export default FlexQueueItem;
}
...
declare module "@salesforce/schema/FlexQueueItem.UserRecordAccess" {
    import { FieldId } from "@salesforce/schema";
