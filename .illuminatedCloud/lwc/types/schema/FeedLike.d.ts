...
declare module "@salesforce/schema/FeedLike" {
    import { ObjectId } from "@salesforce/schema";
    const FeedLike: ObjectId;
    export default FeedLike;
}

declare module "@salesforce/schema/FeedLike.ContextRecord" {
...
declare module "@salesforce/schema/FeedLike.RelatedRecord" {
    import { FieldId } from "@salesforce/schema";
    const RelatedRecord: FieldId;
    export default RelatedRecord;
}

declare module "@salesforce/schema/FeedLike.UserRecordAccess" {
    import { FieldId } from "@salesforce/schema";
