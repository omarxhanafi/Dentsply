...
declare module "@salesforce/schema/EntitySubscription" {
    import { ObjectId } from "@salesforce/schema";
    const EntitySubscription: ObjectId;
    export default EntitySubscription;
}

declare module "@salesforce/schema/EntitySubscription.ContextRecord" {
...
declare module "@salesforce/schema/EntitySubscription.RelatedRecord" {
    import { FieldId } from "@salesforce/schema";
...
declare module "@salesforce/schema/EntitySubscription.Subscriber" {
    import { FieldId } from "@salesforce/schema";
    const Subscriber: FieldId;
    export default Subscriber;
}

declare module "@salesforce/schema/EntitySubscription.SubscriberId" {
    import { FieldId } from "@salesforce/schema";
    const SubscriberId: FieldId;
    export default SubscriberId;
}

declare module "@salesforce/schema/EntitySubscription.UserRecordAccess" {
    import { FieldId } from "@salesforce/schema";
