...
declare module "@salesforce/schema/DocumentAttachmentMap" {
    import { ObjectId } from "@salesforce/schema";
    const DocumentAttachmentMap: ObjectId;
    export default DocumentAttachmentMap;
}
...
declare module "@salesforce/schema/DocumentAttachmentMap.DocumentSequence" {
    import { FieldId } from "@salesforce/schema";
    const DocumentSequence: FieldId;
...
declare module "@salesforce/schema/DocumentAttachmentMap.UserRecordAccess" {
    import { FieldId } from "@salesforce/schema";
