...
declare module "@salesforce/schema/OwnerChangeOptionInfo" {
    import { ObjectId } from "@salesforce/schema";
    const OwnerChangeOptionInfo: ObjectId;
    export default OwnerChangeOptionInfo;
}

declare module "@salesforce/schema/OwnerChangeOptionInfo.ChildOwnerChangeOptionInfo" {
    import { FieldId } from "@salesforce/schema";
    const ChildOwnerChangeOptionInfo: FieldId;
    export default ChildOwnerChangeOptionInfo;
}
...
declare module "@salesforce/schema/OwnerChangeOptionInfo.UserRecordAccess" {
    import { FieldId } from "@salesforce/schema";
