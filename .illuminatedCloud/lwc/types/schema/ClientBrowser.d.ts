...
declare module "@salesforce/schema/ClientBrowser" {
    import { ObjectId } from "@salesforce/schema";
    const ClientBrowser: ObjectId;
...
declare module "@salesforce/schema/ClientBrowser.ProxyInfo" {
    import { FieldId } from "@salesforce/schema";
    const ProxyInfo: FieldId;
    export default ProxyInfo;
}

declare module "@salesforce/schema/ClientBrowser.UserRecordAccess" {
    import { FieldId } from "@salesforce/schema";
