...
declare module "@salesforce/schema/ResourceAbsenceHistory" {
    import { ObjectId } from "@salesforce/schema";
    const ResourceAbsenceHistory: ObjectId;
    export default ResourceAbsenceHistory;
}
...
declare module "@salesforce/schema/ResourceAbsenceHistory.DataType" {
    import { FieldId } from "@salesforce/schema";
