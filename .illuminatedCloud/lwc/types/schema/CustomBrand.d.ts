...
declare module "@salesforce/schema/CustomBrand" {
    import { ObjectId } from "@salesforce/schema";
    const CustomBrand: ObjectId;
...
declare module "@salesforce/schema/CustomBrand.CustomBrandAssets" {
    import { FieldId } from "@salesforce/schema";
    const CustomBrandAssets: FieldId;
...
declare module "@salesforce/schema/CustomBrand.UserRecordAccess" {
    import { FieldId } from "@salesforce/schema";
