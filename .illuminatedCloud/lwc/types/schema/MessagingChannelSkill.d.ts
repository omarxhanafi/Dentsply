...
declare module "@salesforce/schema/MessagingChannelSkill" {
    import { ObjectId } from "@salesforce/schema";
    const MessagingChannelSkill: ObjectId;
    export default MessagingChannelSkill;
}
...
declare module "@salesforce/schema/MessagingChannelSkill.UserRecordAccess" {
    import { FieldId } from "@salesforce/schema";
