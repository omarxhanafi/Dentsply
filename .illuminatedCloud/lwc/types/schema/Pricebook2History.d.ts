...
declare module "@salesforce/schema/Pricebook2History" {
    import { ObjectId } from "@salesforce/schema";
    const Pricebook2History: ObjectId;
    export default Pricebook2History;
}
...
declare module "@salesforce/schema/Pricebook2History.DataType" {
    import { FieldId } from "@salesforce/schema";
...
declare module "@salesforce/schema/Pricebook2History.UserRecordAccess" {
    import { FieldId } from "@salesforce/schema";
