...
declare module "@salesforce/schema/Domain.DomainSites" {
    import { FieldId } from "@salesforce/schema";
    const DomainSites: FieldId;
    export default DomainSites;
}

declare module "@salesforce/schema/Domain.DomainType" {
    import { FieldId } from "@salesforce/schema";
    const DomainType: FieldId;
    export default DomainType;
}

declare module "@salesforce/schema/Domain.HttpsOption" {
    import { FieldId } from "@salesforce/schema";
    const HttpsOption: FieldId;
...
declare module "@salesforce/schema/Domain.OptionsHstsPreload" {
    import { FieldId } from "@salesforce/schema";
    const OptionsHstsPreload: FieldId;
...
declare module "@salesforce/schema/Domain.UserRecordAccess" {
    import { FieldId } from "@salesforce/schema";
