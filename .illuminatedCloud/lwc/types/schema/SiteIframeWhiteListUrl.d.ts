...
declare module "@salesforce/schema/SiteIframeWhiteListUrl" {
    import { ObjectId } from "@salesforce/schema";
    const SiteIframeWhiteListUrl: ObjectId;
    export default SiteIframeWhiteListUrl;
}
...
declare module "@salesforce/schema/SiteIframeWhiteListUrl.UserRecordAccess" {
    import { FieldId } from "@salesforce/schema";
