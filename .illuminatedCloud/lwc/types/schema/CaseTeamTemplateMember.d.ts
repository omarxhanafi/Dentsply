...
declare module "@salesforce/schema/CaseTeamTemplateMember" {
    import { ObjectId } from "@salesforce/schema";
    const CaseTeamTemplateMember: ObjectId;
    export default CaseTeamTemplateMember;
}
...
declare module "@salesforce/schema/CaseTeamTemplateMember.UserRecordAccess" {
    import { FieldId } from "@salesforce/schema";
