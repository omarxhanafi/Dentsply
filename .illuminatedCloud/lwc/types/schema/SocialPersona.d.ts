...
declare module "@salesforce/schema/SocialPersona" {
    import { ObjectId } from "@salesforce/schema";
    const SocialPersona: ObjectId;
    export default SocialPersona;
}

declare module "@salesforce/schema/SocialPersona.ApprovalSubmissions" {
    import { FieldId } from "@salesforce/schema";
    const ApprovalSubmissions: FieldId;
    export default ApprovalSubmissions;
}

declare module "@salesforce/schema/SocialPersona.ApprovalWorkItems" {
    import { FieldId } from "@salesforce/schema";
...
declare module "@salesforce/schema/SocialPersona.AvatarUrl" {
    import { FieldId } from "@salesforce/schema";
    const AvatarUrl: FieldId;
    export default AvatarUrl;
}

declare module "@salesforce/schema/SocialPersona.ContextRecord" {
    import { FieldId } from "@salesforce/schema";
...
declare module "@salesforce/schema/SocialPersona.CurrencyIsoCode" {
    import { FieldId } from "@salesforce/schema";
...
declare module "@salesforce/schema/SocialPersona.ExternalPictureURL" {
    import { FieldId } from "@salesforce/schema";
    const ExternalPictureURL: FieldId;
    export default ExternalPictureURL;
}

declare module "@salesforce/schema/SocialPersona.FlowOrchestrationWorkItems" {
    import { FieldId } from "@salesforce/schema";
    const FlowOrchestrationWorkItems: FieldId;
    export default FlowOrchestrationWorkItems;
}

declare module "@salesforce/schema/SocialPersona.Histories" {
    import { FieldId } from "@salesforce/schema";
...
declare module "@salesforce/schema/SocialPersona.RecordActionHistories" {
    import { FieldId } from "@salesforce/schema";
    const RecordActionHistories: FieldId;
    export default RecordActionHistories;
}

declare module "@salesforce/schema/SocialPersona.RecordActions" {
    import { FieldId } from "@salesforce/schema";
    const RecordActions: FieldId;
    export default RecordActions;
}

declare module "@salesforce/schema/SocialPersona.RelatedRecord" {
    import { FieldId } from "@salesforce/schema";
    const RelatedRecord: FieldId;
    export default RelatedRecord;
}

declare module "@salesforce/schema/SocialPersona.SobjectLookupValue" {
    import { FieldId } from "@salesforce/schema";
...
declare module "@salesforce/schema/SocialPersona.Target" {
    import { FieldId } from "@salesforce/schema";
    const Target: FieldId;
    export default Target;
}

declare module "@salesforce/schema/SocialPersona.TargetObject" {
    import { FieldId } from "@salesforce/schema";
    const TargetObject: FieldId;
    export default TargetObject;
}

declare module "@salesforce/schema/SocialPersona.UserRecordAccess" {
    import { FieldId } from "@salesforce/schema";
