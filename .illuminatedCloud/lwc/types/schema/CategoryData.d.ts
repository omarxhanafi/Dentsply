...
declare module "@salesforce/schema/CategoryData" {
    import { ObjectId } from "@salesforce/schema";
    const CategoryData: ObjectId;
...
declare module "@salesforce/schema/CategoryData.RelatedSobjectId" {
    import { FieldId } from "@salesforce/schema";
    const RelatedSobjectId: FieldId;
...
declare module "@salesforce/schema/CategoryData.UserRecordAccess" {
    import { FieldId } from "@salesforce/schema";
