...
declare module "@salesforce/schema/CaseTeamTemplateRecord" {
    import { ObjectId } from "@salesforce/schema";
    const CaseTeamTemplateRecord: ObjectId;
    export default CaseTeamTemplateRecord;
}
...
declare module "@salesforce/schema/CaseTeamTemplateRecord.UserRecordAccess" {
    import { FieldId } from "@salesforce/schema";
