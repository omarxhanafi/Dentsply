...
export default class SelectProductsOmLwc extends LightningElement {
    ...
    orderItemObjectInfo({data, error}){

        if(data){
            this.orderItemObjectInfo = data;
            this.orderItemUnitPriceLabel = data.fields.UnitPrice.label;
        }

    }
    get orderItemRetailPriceLabel() {
        return this.orderItemObjectInfo.fields ? this.orderItemObjectInfo.fields.AXRetailPrice__c.label : '';
    }


    
    /*get orderItemUnitPriceLabel() {
        console.log('Collecting unit price label: ' + JSON.stringify(this.orderItemObjectInfo));
        return this.orderItemObjectInfo.data.fields ? this.orderItemObjectInfo.data.fields.UnitPrice.label : '';
    }*/
