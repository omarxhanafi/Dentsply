...
<CustomMetadata xmlns="http://soap.sforce.com/2006/04/metadata" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema">
    <label>DE/AT Implants Stage 3</label>
    ...
    <values>
        ...
        <value xsi:type="xsd:string">- Probe OP, Hands On und Angebotserstellung.    
- Gemeinschaftliche Besuche mit Experten.    
- Eventuelle Kursteilnahme oder Hospitation.  
- Erwartete Umsatzgröße festlegen.</value>
    </values>
    <values>
        <field>StageGuidance__c</field>
        <value xsi:type="xsd:string">Maßnahmen und Aktionen:</value>
    </values>
</CustomMetadata>
