...
<CustomMetadata xmlns="http://soap.sforce.com/2006/04/metadata" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema">
    <label>IT Orthodontics 4. Negotiation</label>
    ...
    <values>
        ...
        <value xsi:type="xsd:string">Si consiglia di ricontattare il cliente per verificare la sua disponibilità all&apos;acquisto</value>
    </values>
    <values>
        <field>StageGuidance__c</field>
        <value xsi:type="xsd:string">Opportunità in fase di negoziazione</value>
    </values>
</CustomMetadata>
