...
<CustomMetadata xmlns="http://soap.sforce.com/2006/04/metadata" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema">
    <label>Nordics Prosthetics Closed Won</label>
    ...
    <values>
        ...
        <value xsi:type="xsd:string">Won Equipment: when Training is booked with Digital Lab Trainer.​
Won Consumables:​when customer has confirmed they work with the product​</value>
    </values>
    <values>
