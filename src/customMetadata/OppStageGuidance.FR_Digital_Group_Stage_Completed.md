...
<CustomMetadata xmlns="http://soap.sforce.com/2006/04/metadata" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema">
    <label>FR Digital Group Stage Completed</label>
    ...
    <values>
        ...
        <value xsi:type="xsd:string">Ce statut indique que le client a été contacté et suite à son intérêt, il a été converti en opportunité.
C&apos;est désormais dans l&apos;opportunité qu&apos;il faut compléter les différentes étapes de progression.</value>
    </values>
    <values>
