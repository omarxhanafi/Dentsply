...
<CustomMetadata xmlns="http://soap.sforce.com/2006/04/metadata" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema">
    <label>GB Prosthetics Stage 3</label>
    ...
    <values>
        ...
        <value xsi:type="xsd:string">Passed to dealer for official quotation or on site meeting.; Opportunity to be followed up by the dealer product specialist to point of closure and progress reported to DS regularly or when requested.</value>
    </values>
    <values>
        <field>StageGuidance__c</field>
        <value xsi:type="xsd:string">Quotation</value>
    </values>
</CustomMetadata>
